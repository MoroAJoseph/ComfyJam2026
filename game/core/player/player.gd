...
func _drop_items_at_location(_items: Array, _location: Vector3) -> void:
	pass
	#for item in items:
		#EventBus.emit(
...
func _on_item_collection_area_area_entered(_area: Area3D) -> void:
	pass
...
func _handle_game_event_block_hover_updated(_event: GameEvent) -> void:
	pass
